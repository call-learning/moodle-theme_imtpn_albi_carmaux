 ...
 */
function theme_imtpn_albi_carmaux_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
 ...
 * @param $page
 */
function theme_imtpn_albi_carmaux_page_init($page) {
